...
- **Active metric limitation:** workspace Recent new accounts is a feed count capped at 100, not total users; project Overview uses a separate 30-day aggregate → prevention: preserve the labels and do not reuse snapshot.events for aggregate charts.
